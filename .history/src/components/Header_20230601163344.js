...
// Import a constant from the '@thirdweb-dev/sdk' package
...
const Header = () => {
    ...
    // Define a function to handle the display of the balance
    const handleBalance = () => {
    ...
    // Define a function to handle the display of the connected wallet address
    ...
    // Define a function to handle the display of the connected chain
